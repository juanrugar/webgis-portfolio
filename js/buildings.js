function addEdificiosCapa() {
    ...
    map.addSource("edificios_source", {
        "type": "vector",
        "url": "mapbox://juanrugar.dhogwfvq"  // Nuestor ID Tileset
    ...
    map.addLayer({
        ...
        "source-layer": "construcciones-3s45m5", // Nuestro nombre Tileset
        "maxzoom": 21,
        "minzoom": 15,
        "filter": [">", "numberOfFl", 0],
        "paint": {
...
function filtrarEdificios(valor) {
    ...
    document.getElementById("altura").innerHTML = "Over floor nº <b>" + valor;

} // END filtrarEdificios()
